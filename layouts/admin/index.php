...
<h1 class="font-normal text-2xl be-vietnam-pro-black">Trang chủ</h1>

<?php
require_once ROOT_PATH . '/layouts/admin/chart/index.php';
require_once ROOT_PATH . '/layouts/admin/best_seller/index.php';
require_once ROOT_PATH . '/layouts/admin/last_orders.php';
?>
