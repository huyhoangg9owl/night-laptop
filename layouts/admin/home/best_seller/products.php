<table class="w-full divide-y divide-gray-200 dark:divide-gray-700 rounded-lg overflow-hidden shadow-md">
    <thead class="bg-gray-50 dark:bg-gray-800">
        <tr>
            <th scope="col" colspan="4" class="py-3.5 px-4 text-xl font-normal text-black dark:text-white text-center border-b dark:border-b-gray-700">
    ...
    <tbody class="bg-white divide-y divide-gray-200 dark:divide-gray-700 dark:bg-gray-900">
        <?php foreach ($best_seller_products as $key => $item) : ?>
            <tr>
                ...
                <td class="px-4 py-4 text-sm whitespace-nowrap">
                    <p class="text-gray-800 dark:text-white text-center"><?= number_format($item['profit']) ?></p>
                </td>
            </tr>
        <?php endforeach; ?>
    </tbody>
