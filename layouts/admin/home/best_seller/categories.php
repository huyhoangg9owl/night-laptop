<table class="w-full divide-y divide-gray-200 rounded-lg overflow-hidden shadow-md">
    <thead class="bg-gray-50">
        <tr>
            <th scope="col" colspan="3" class="py-3.5 px-4 text-xl font-normal text-black text-center border-b dark:border-b-gray-700">
            ...
            <tr>
                <td class="px-12 py-4 text-sm font-medium">
                    <div class="flex flex-col items-start justify-center">
                        <h2 class="font-medium text-gray-800 text-left max-w-full"><?= $item['name'] ?></h2>
                    </div>
                </td>
                <td class="px-4 py-4 text-sm whitespace-nowrap">
                    <p class="text-gray-800 text-center"><?= number_format($item['total_product']) ?></p>
                </td>
                <td class="px-4 py-4 text-sm whitespace-nowrap">
