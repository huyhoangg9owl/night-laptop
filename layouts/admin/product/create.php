...
<form class="w-full bg-white p-6 rounded-lg shadow-lg" method="post" action="/services/product/create" enctype="multipart/form-data">
    <div class="mb-4">
        ...
        <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="name" name="name" type="text" placeholder="Nhập tên sản phẩm" value="<?= $name ?>" required>
    </div>
    ...
    <div class="mb-4">
        ...
        <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="price" name="price" type="number" placeholder="Nhập giá sản phẩm" value="<?= $price ?>" required>
    </div>
    ...
    <div class="mb-4">
        <label class="block text-gray-700 text-sm font-bold mb-2 w-fit" for="thumbnail_image">
            Ảnh bìa sản phẩm (750 x 750)
            <input class="hidden" id="thumbnail_image" name="thumbnail_image" type="file" accept="image/*">
            <img id="thumbnail-preview" class="mt-2 max-w-40 border border-dotted" src="/public/favicon.ico" alt="thumbnail">
        </label>
    </div>
    ...
    <div class="mb-4">
        ...
        <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="quantity" name="quantity" type="number" placeholder="Nhập số lượng sản phẩm" value="<?= $quantity ?>" required>
    </div>
