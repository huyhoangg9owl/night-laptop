...
<table class="w-full divide-y divide-gray-200 dark:divide-gray-700 rounded-lg overflow-hidden shadow-md mt-8">
    <thead class="bg-gray-50 dark:bg-gray-800">
        <tr>
            <th scope="col" colspan="6" class="py-3.5 px-4 text-xl font-normal text-black dark:text-white text-center border-b dark:border-b-gray-700">
                Đơn hàng gần nhất
            </th>
        </tr>
        <tr>
            <th scope="col" class="px-12 py-3.5 text-sm font-normal text-gray-500 dark:text-gray-400 text-center">
                Mã đơn hàng
            </th>
            <th scope="col" class="px-12 py-3.5 text-sm font-normal text-gray-500 dark:text-gray-400 text-center">
                Khách hàng
    ...
    <tbody class="bg-white dark:bg-gray-900 divide-y divide-gray-200 dark:divide-gray-800">
        <?php foreach ($orders as $order) : ?>
            <tr>
                <td class="px-12 py-4 text-sm font-normal text-dark dark:text-white text-center">
                    <?= $order['order_id'] ?>
                </td>
                <td class="px-12 py-4 text-sm font-normal text-dark dark:text-white">
                    <?= $order['customer_name'] ?>
                </td>
                <td class="px-12 py-4 text-sm font-normal text-dark dark:text-white">
                    <?= $order['order_product'] ?>
